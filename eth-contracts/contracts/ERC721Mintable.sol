...
contract Ownable {
    ...
    constructor() internal {
        ...
        emit OwnerChange("Owner has changed");
    }
    ...
    event OwnerChange(string arg);

    function transferOwnership(address newOwner) public onlyOwner {
        // TODO add functionality to transfer control of the contract to a newOwner.
        // make sure the new owner is a real address

        require(!newOwner.isContract(), "Contracts cannot be owner");
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(ownerOf(tokenId) != to, "Cannot self approve");

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(owner() == msg.sender || isApprovedForAll(ownerOf(tokenId), msg.sender), "Caller cannot approve");
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(!to.isContract(), "cannot mint to invalid address");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(!to.isContract(), "cannot transfer to invalid address");
...
contract MMMakhashinERC721Token
    is ERC721Metadata("Murad M Makhashin", "MMM", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {

        function mint(address to, uint256 tokenId, string memory tokenURI) public onlyOwner returns(bool) {
            require(msg.sender == owner(), "only contract owner can mint new token");
            super._mint(to, tokenId);
